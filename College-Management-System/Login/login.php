...
<html lang="en">
	<head>
		<title>Login - NECN</title>
	</head>
	<body class="login-bacground">
		<?php include('../common/common-header.php') ?>
        <div class="login-div mt-2 rounded">
            <div class="logo-div text-center">
                <img src="../Images/10.jpg" alt="" class="align-items-center" width="100" height="100">
            </div>
